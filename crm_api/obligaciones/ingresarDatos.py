...
# Función para ingresar los datos desde un DataFrame a las bases de datos correspondientes
def ingresar_datos(df, campaña):
    cantObligacionesRepetidas = 0  # Contador de obligaciones repetidas
    # Iterar sobre cada fila del DataFrame
    for _, fila in df.iterrows():
        # Obtener o crear una instancia de Cliente
        ...
        # Ingresar teléfonos del cliente
        for i in range(10):
        ...
        # Si existen datos de codeudor, crear o obtener la instancia de Codeudor
        ...
        # Crear relación entre cliente y referencia
    ...
    # Imprimir cantidad de obligaciones repetidas
